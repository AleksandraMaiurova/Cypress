describe('Пример теста с Ozon', function () {
    it('Путь до корзины в Ozon', function () {
        cy.visit('https://www.ozon.ru/');
        cy.get("input[type='text']:first").type('playstation').type('{enter}');
        cy.contains('playstation');
        ...
        cy.get('.o8a > .de1 > span').contains('Александра');
    })
})